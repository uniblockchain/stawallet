...
object RpcClientFactory {
    ...
    fun createBitcoinClient(
        ...
        jsonRpcHttpClient = JsonRpcHttpClient(
            ObjectMapperFactory.getObjectMapper().configure(SerializationFeature.WRITE_NULL_MAP_VALUES, false).setSerializationInclusion(JsonInclude.Include.NON_NULL),
...
data class BlockChainInfo(
    ...
    val initialblockdownload: Any? = null,
    val size_on_disk: Any? = null,
...
data class BytesPerMessage(
    ...
    val inv: Long? = null,
    val version: Long? = null,
    val feefilter: Any? = null,
    val getaddr: Any? = null,
    val getdata: Any? = null,
    val sendcmpct: Any? = null,
    val sendheaders: Any? = null,
    val block: Any? = null,
...
data class AddressOrScript(
    val scriptPubKey: Any,  // "<script>" | { "address":"<address>" }, (string / json, required) Type of scriptPubKey (string for script, json for address)
    val timestamp: Any, //timestamp | "now", (integer / string, required)
    val redeemscript: String? = null,
    val pubkeys: List<String>? = null,
    val keys: List<String>? = null,
    val internal: Boolean? = null,
    val watchonly: Boolean? = null,
    val label: String? = null
)

data class ImportAddressOptions(
    val rescan: Boolean? = null
)

data class EstimateSmartResult(
